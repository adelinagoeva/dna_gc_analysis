...
with open( input_data_file, "r" ) as file:
    for line in file:
        ...
        print( f"name = {bacteria_name} : GC = {gc_value} and GC3 = {gc3_value}" )


x = np.arange( 1, len( bacteria_list ) + 1 )
median = np.median( gc3_list )
...
# Legend entries describing marker type
plt.scatter(
    [],
    [],
    color = "black",
...
plt.title(
	"GC and GC3 content of all thermal groups",
	fontsize = 20,
    fontweight = "bold"
)
